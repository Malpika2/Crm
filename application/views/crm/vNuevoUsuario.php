      ...
      <div class="row">
        ...
        <div class="col-md-12 divsNP">
              <div class="input-group">
                ...
                <input type="text" class="col-sm-12 col-md-5 formsNP2" id="Calle" name="Calle" placeholder="Calle">
                <input type="text" class="col-sm-12 col-md-3 formsNP2" id="Numero" name="Numero" placeholder="Número">
                <input type="text" class="col-sm-12 col-md-4 formsNP2" id="Colonia" name="Colonia" placeholder="Colonia">

                <input type="text" class="col-sm-12 col-md-4 formsNP2" id="Municipio" name="Municipio" placeholder="Municipio">
                <input type="text" class="col-sm-12 col-md-3 formsNP2" id="Estado" name="Estado" placeholder="Estado">
                <input type="text" class="col-sm-12 col-md-2 formsNP2" id="Cp" name="Cp" placeholder="C.P:">
                <input type="text" class="col-sm-12 col-md-3 formsNP2" id="Pais" name="Pais" placeholder="Pais:">
              </div>
        </div>

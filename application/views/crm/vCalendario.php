  	...
  	<div class="container-fluid">
		...
		<div class="col-md-4" style="padding-top: 80px;">
			<div class="box box-info">
				<div id="divTitleTarea" class="box-header text-center ">
					<label id="Tarea" class="h2" style="margin: 0px"><small>Para consultar la información de un evento: hacer clic en el calendario sobre el nombre del evento</small></label>
				</div>

...
<?php if($this->session->userdata('s_Nombre')=='Yasser'){;?><button type="button" class="btn btn-info pull-right" data-toggle="modal" data-target="#ModalTareasForo">Tareas</button><?php } ?>
